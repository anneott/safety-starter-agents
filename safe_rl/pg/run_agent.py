...
def run_polopt_agent(env_fn,
                     ...
                     epochs=50,
                     max_ep_len=20000,#10000,#5000,#1000,
                     # Discount factors:
                     gamma=0.99,
                     lam=0.97,
                     cost_gamma=0.99,
    ...
    np.random.seed(seed)
    env = env_fn()  # new safety gym environment is created here
    ...
    for epoch in range(epochs):
        ...
        for t in range(local_steps_per_epoch):
            ...
            if ep_len % 1000 == 0:
                print('EP LEN', ep_len, max_ep_len,'t', t, 'local steps', local_steps_per_epoch, 'ep ret', ep_ret)
            ...
            if terminal or (t==local_steps_per_epoch-1):
                ...
                if terminal:
                    print('Only save EpRet / EpLen if trajectory finished, ep_return', ep_ret, ', ep_cost:', ep_cost, ', ', t)
